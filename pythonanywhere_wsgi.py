...
# 1. Ваш логин на PythonAnywhere
PA_USERNAME = 'voteplatformbackend'

# 2. Путь к директории backend на PythonAnywhere
# Если репозиторий клонирован в домашнюю директорию:
project_home = f'/home/{PA_USERNAME}/Vote-platform-backend/backend'

# Если репозиторий клонирован без подпапки backend (только бэкенд в корне):
if not os.path.exists(project_home):
    project_home = f'/home/{PA_USERNAME}/Vote-platform-backend'

# Если файл лежит непосредственно в рабочей папке:
