...
## Этап 2 — Голосование: корректность и конкуррентность ⭐ ядро
...
## Этап 3 — Аутентификация без DB-запроса на каждый request
...
## Этап 4 — Устранение N+1 на hot endpoints
...
## Этап 5 — Индексы и schema performance
...
## Этап 11 — Профилирование и вторая итерация оптимизации
