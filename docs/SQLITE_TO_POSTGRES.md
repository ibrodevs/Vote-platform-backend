...
**Статус документа:** процедура составлена и проверена на локальной dev-базе
(19 студентов, 14 голосов). На production-объёме **не выполнялась** — первый
прогон делается по этой инструкции с обязательным backup.
