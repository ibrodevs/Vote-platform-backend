...
- **Source code:** `/home/voteplatformbackend/Vote-platform-backend`
- **Working directory:** `/home/voteplatformbackend/Vote_project/backend`

### 2) Virtualenv (Виртуальное окружение)

- Нажмите на ссылку и укажите путь:
  `/home/voteplatformbackend/.virtualenvs/vote_env`
